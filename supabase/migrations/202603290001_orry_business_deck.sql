...
CREATE INDEX IF NOT EXISTS "BusinessDocument_kind_status_idx" ON "BusinessDocument"("kind", "status");
CREATE INDEX IF NOT EXISTS "BusinessDocument_contact_idx" ON "BusinessDocument"("contactId");
CREATE INDEX IF NOT EXISTS "DocumentActivity_document_idx" ON "DocumentActivity"("documentId", "createdAt");
CREATE INDEX IF NOT EXISTS "PaymentEntry_document_idx" ON "PaymentEntry"("documentId", "paidAt");
